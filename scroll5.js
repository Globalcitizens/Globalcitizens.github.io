...
$(document).ready(function(){
    var URL = "1wroLNBMWBQWCgTt53Xy57z_YOyUBsKrtrs40HFynmSU";
    Tabletop.init( { key: URL, callback: convertToGeoJSON5, simpleSheet: true } );
    ...
    $("#articleWindow5").children("h3").text("News for Europe");
    
});

articles = [];

function convertToGeoJSON5(data) {
    console.log(data);
    ...
    for(n=0; n<10; n++){
        ...
        $("#articleWindow5").children("ul").append(articleThing);
        var stringy = "ul li:nth-child(" + (n+1) + ")";
        $("#articleWindow5").find(stringy).children("a").attr("href", artLink);
    }
}
